package br.com.a3ysoftwarehouse.vcdguest.ui.listPassenger.adapter;
...
public class ListPassengerAdapter extends RecyclerView.Adapter<ListPassengerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Picasso.with(App.getContext())
                ...
                .placeholder(
                        new IconicsDrawable(App.getContext())
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.passenger_profile_iv) CircularImageView passengerProfileIv;
        @BindView(R.id.passenger_name_tv) TextView nameTv;
        @BindView(R.id.tag_iv) ImageView tagIv;
